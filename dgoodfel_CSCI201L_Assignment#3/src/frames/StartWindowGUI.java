...
public class StartWindowGUI extends JFrame{
	...
	private JLabel fileNameLabel, ratingLabel;
	...
	private void createGUI(){
		...
		AppearanceSettings.setBackground(Color.darkGray, exitButton, clearDataButton, startGameButton, logoutButton, slider,
		...
		//setting fonts
		AppearanceSettings.setFont(AppearanceConstants.fontMedium, teamNameTextFields.get(0), teamNameTextFields.get(1), teamNameTextFields.get(2), teamNameTextFields.get(3),
				teamNameLabels.get(0), teamNameLabels.get(1), teamNameLabels.get(2), teamNameLabels.get(3), 
				exitButton, clearDataButton, startGameButton, logoutButton);
		
		AppearanceSettings.setFont(AppearanceConstants.fontSmall, fileChooserButton, fileNameLabel, ratingLabel);
		
		//other
		AppearanceSettings.setForeground(Color.lightGray, exitButton, clearDataButton, startGameButton, logoutButton,
				teamNameLabels.get(0), teamNameLabels.get(1), teamNameLabels.get(2), teamNameLabels.get(3), fileChooserButton,ratingLabel,
				fileNameLabel, slider);

		AppearanceSettings.setOpaque(exitButton, clearDataButton, startGameButton, logoutButton, slider,
				teamNameLabels.get(0), teamNameLabels.get(1), teamNameLabels.get(2), teamNameLabels.get(3), fileChooserButton);

		AppearanceSettings.setSize(250, 70, exitButton, clearDataButton, logoutButton, startGameButton);
		AppearanceSettings.unSetBorderOnButtons(exitButton, clearDataButton, startGameButton, logoutButton, fileChooserButton);
		
		AppearanceSettings.setTextAlignment(teamNameLabels.get(0), teamNameLabels.get(1), teamNameLabels.get(2), teamNameLabels.get(3),
				fileNameLabel, ratingLabel);
	...
	private void setHaveValidFile(File file){
		...
		try{
			...
			ratingLabel.setText("average rating: " + Integer.toString(gameData.getRating()) + "/5");
