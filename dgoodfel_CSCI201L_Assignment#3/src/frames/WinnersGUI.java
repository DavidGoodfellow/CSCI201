...
public class WinnersGUI extends JFrame{
	...
	private void createGUI(){
		...
		ratingLabel.setBackground(Color.darkGray);
		ratingLabel.setBorder(new EmptyBorder(2,2,2,2));
		...
		please.setHorizontalAlignment((int)this.CENTER_ALIGNMENT);
		centerC.add(please);
		...
		sliderP.add(rating, BorderLayout.CENTER);
		//ratingLabelPanel.add(ratingLabel);
		sliderP.add(ratingLabel, BorderLayout.EAST);
		centerC.add(sliderP);
		winnersL.setHorizontalAlignment(JLabel.CENTER);
		current.setHorizontalAlignment((int)this.CENTER_ALIGNMENT);
		centerC.add(current);
		...
		okay.setBorder(new EmptyBorder(0,100,0,100));
