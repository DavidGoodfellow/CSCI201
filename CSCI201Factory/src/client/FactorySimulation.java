...
public class FactorySimulation {
	...
	private FactoryCoffeeStation mCoffee;
	private FactoryDiningStation mDining;
	...
	FactorySimulation(Factory inFactory, JTable inTable, FactoryManager fm) {
		...
		//create the coffee station
		Point coffeeLocation = mFactory.getCoffeeLocation();
		mCoffee = new FactoryCoffeeStation(coffeeLocation.x,coffeeLocation.y);
		mFObjects.add(mCoffee);
		mFNodes[coffeeLocation.x][coffeeLocation.y].setObject(mCoffee);
		mFNodeMap.put("Coffee Shop", mFNodes[coffeeLocation.x][coffeeLocation.y]);
		
		//create the Dining station
		Point diningLocation = mFactory.getDiningLocation();
		mDining = new FactoryDiningStation(diningLocation.x,diningLocation.y);
		mFObjects.add(mDining);
		mFNodes[diningLocation.x][diningLocation.y].setObject(mDining);
		mFNodeMap.put("Dining Table", mFNodes[diningLocation.x][diningLocation.y]);
	...
	public void update(double deltaTime) {
		...
		if(mTaskBoard.isDone())
		{
			...
			ArrayList<String> coffeeOrders = mCoffee.getOrders();
			fm.sendOrders(coffeeOrders);
